...
def plot_convergence(histories: Dict[str, List[np.ndarray]], title: str = "Convergence"):
    """
...
def plot_all_results(results: Dict):
    ...
    plot_comparison(results, "Bayesian Optimization with Constraints - Method Comparison")
